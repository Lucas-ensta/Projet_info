...
class TestComportement(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.fourmi.memoire = [(2, 1)]  # ou n'importe quelle position valable
...
# ============= classe Suivi ================ #
    ...
    def test_suivi_choisir_direction(self):
        ...
        """
        # nourriture perçue en bas
        self.fourmi.percevoir_nourriture.return_value = {"haut": False, "bas": True}
        ...
        self.labyrinthe.etat_case = {
            0: {
                1: MagicMock(pheromones={"attractif": 2.0, "repulsif": 0.0}, nourriture=False)
            },
            2: {
                1: MagicMock(pheromones={"attractif": 1.0, "repulsif": 0.0}, nourriture=True)
            }
        }
...
# ============= classe Retour ================ #
    ...
    def test_retour_choisir_pheromone(self):
        ...
        self.fourmi.chemins_possible.return_value = ["bas"]
        comportement = Retour()
        pheromone = comportement.choisir_pheromone(self.fourmi, self.labyrinthe)
        
        # La fourmi doit déposer une phéromone répulsive en cul de sac
